...
public class DBConnect {
    public static Connection setupConnection()
    {
        /*
         ...
         - vendor (e.g., oracle)
         - driver (e.g., thin)
         - server (e.g., 157.89.28.130)
         - port number (e.g., default 1521)
         - database instance name (e.g., cscdb)
         */
        
        String jdbcDriver = "oracle.jdbc.driver.OracleDriver";
        String jdbcUrl = "jdbc:oracle:thin:@157.89.28.130:1521:cscdb";  // URL for the database
         ...
         */
        String username = "c##MorrisT2021";
        String password = "P#$$4510";
